...
class Blacklist extends BaseModel
{
    ...
    public function structure($structure): array
    {
        ...
        $structure['form'] = [
            ['label' => 'Transfer Blacklist Detail', 'class' => 'col-span-full md:col-span-6 md:pr-2', 'fields' => ['start_date', 'end_date', 'reason', 'partner_id', 'partner_id']],
            ['label' => 'Transfer Blacklist Reason', 'class' => 'col-span-full md:col-span-6 md:pr-2', 'fields' => ['reason']],
        ];
